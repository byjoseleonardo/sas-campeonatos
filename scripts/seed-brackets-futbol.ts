...
// Campeonatos de fútbol donde dejar la llave armada y VACÍA (cruces "Por definir"),
// listos para insertar los VS durante el sorteo presencial.
const CHAMPIONSHIPS = ["Fulbito Libre", "Fulbito Master"];
