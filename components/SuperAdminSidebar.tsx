...
import { LayoutDashboard, Building2, PanelLeft, LogOut, Trophy, X } from "lucide-react";
        ...
        <div className="flex h-14 items-center border-b px-3">
          {collapsed ? (
            ...
            <div className="flex w-full items-center justify-between">
              <Link href="/superadmin" className="flex items-center gap-2" onClick={onMobileClose}>
